...
It calls the builder if the WAVECAR has not already been parsed and the true bloch states contsructed and saved as npz. The builder needs VaspBandUnfolding and PySBT to be installed as modules.
